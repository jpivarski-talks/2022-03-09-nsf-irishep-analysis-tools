...
\begin{columns}
\column{1.08\linewidth}
\only<1>{\includegraphics[width=\linewidth]{pip-allos-uproot-log.pdf}}\only<2>{\includegraphics[width=\linewidth]{pip-allos-awkward-log.pdf}}
\end{columns}
\end{frame}
...
\only<1>{\includegraphics[width=\linewidth]{irishep-as-stars-1.pdf}}\only<2>{\includegraphics[width=\linewidth]{irishep-as-stars-2.pdf}}
