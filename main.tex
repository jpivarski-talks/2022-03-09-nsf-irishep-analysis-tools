...
\begin{frame}{Different from my own expectations when DIANA/HEP started}
\vspace{0.25 cm}
\begin{columns}
...
\uncover<2-3>{\hfill Sought feedback in focus groups and interviews, not just bug reports.}
\end{frame}

\begin{frame}{Python tools $\to$ analysis systems, rather than starting with systems}
\vspace{0.22 cm}
